...
public:	
	...
	UFUNCTION()
	void CreateClone(const FName CloneAttack);
	...
	UFUNCTION()
	void CloneActionEvent(const FName Action);
	...
	virtual int32 TakeHit(const int32 Damage, const int32 Atack) override;
